/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./session_store" />/// <reference path="../vertx-js/vertx" />declare module "vertx-web-js/clustered_session_store" {  export = ClusteredSessionStore;}

/**
 * A session store which stores sessions in a distributed map so they are available across the cluster.
 */

declare interface ClusteredSessionStore  extends SessionStore{                                  }        declare var ClusteredSessionStore: {        
