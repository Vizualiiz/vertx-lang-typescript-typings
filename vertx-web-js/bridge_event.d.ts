/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./sock_js_socket" />/// <reference path="../vertx-js/future" />declare module "vertx-web-js/bridge_event" {  export = BridgeEvent;}
...
/**
   ...
   */
  socket(): SockJSSocket;    }          declare var BridgeEvent: {}