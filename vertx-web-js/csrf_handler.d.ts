/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./routing_context" />declare module "vertx-web-js/csrf_handler" {  export = CSRFHandler;}
...
/**
   ...
   */
  setTimeout(timeout: number): CSRFHandler;    }            declare var CSRFHandler: {            
