/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./template_engine" />/// <reference path="./routing_context" />declare module "vertx-web-js/template_handler" {  export = TemplateHandler;}
...
/**
   ...
   */
  handle(event: RoutingContext): void;                    }      declare var TemplateHandler: {            
