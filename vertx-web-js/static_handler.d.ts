/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./routing_context" />declare module "vertx-web-js/static_handler" {  export = StaticHandler;}
...
/**
   ...
   */
  setEnableRangeSupport(enableRangeSupport: boolean): StaticHandler;    }                                    declare var StaticHandler: {            
