/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./routing_context" />declare module "vertx-web-js/body_handler" {  export = BodyHandler;}
...
/**
   ...
   */
  setDeleteUploadedFilesOnEnd(deleteUploadedFilesOnEnd: boolean): BodyHandler;    }              declare var BodyHandler: {            
