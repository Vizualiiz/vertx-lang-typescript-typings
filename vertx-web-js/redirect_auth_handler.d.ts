/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./auth_handler" />/// <reference path="./routing_context" />/// <reference path="../vertx-auth-common-js/auth_provider" />declare module "vertx-web-js/redirect_auth_handler" {  export = RedirectAuthHandler;}
...
/**
   ...
   */
  addAuthorities(authorities: Array<string>): AuthHandler;                            }            declare var RedirectAuthHandler: {                    
