/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./auth_handler" />/// <reference path="./routing_context" />/// <reference path="../vertx-auth-jwt-js/jwt_auth" />declare module "vertx-web-js/jwt_auth_handler" {  export = JWTAuthHandler;}
...
/**
   ...
   */
  setIgnoreExpiration(ignoreExpiration: boolean): JWTAuthHandler;    }                declare var JWTAuthHandler: {                    
