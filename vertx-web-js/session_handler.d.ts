/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./session_store" />/// <reference path="./routing_context" />declare module "vertx-web-js/session_handler" {  export = SessionHandler;}
...
/**
   ...
   */
  setSessionCookieName(sessionCookieName: string): SessionHandler;    }              declare var SessionHandler: {            
