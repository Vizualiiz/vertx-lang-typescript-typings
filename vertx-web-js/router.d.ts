/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./route" />/// <reference path="../vertx-js/http_server_request" />/// <reference path="../vertx-js/vertx" />/// <reference path="./routing_context" />declare module "vertx-web-js/router" {  export = Router;}
...
/**
   ...
   */
  handleFailure(context: RoutingContext): void;    }                                                                                declare var Router: {        
