/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./routing_context" />/// <reference path="../vertx-auth-common-js/auth_provider" />declare module "vertx-web-js/form_login_handler" {  export = FormLoginHandler;}
 ...
 * without being redirected here first
   */
  setDirectLoggedInOKURL(directLoggedInOKURL: string): FormLoginHandler;    }              declare var FormLoginHandler: {            
