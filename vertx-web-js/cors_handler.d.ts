/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./routing_context" />declare module "vertx-web-js/cors_handler" {  export = CorsHandler;}

/**
 * A handler which implements server side http://www.w3.org/TR/cors/[CORS] support for Vert.x-Web.
 */

declare interface CorsHandler{            
...
/**
   ...
   */
  maxAgeSeconds(maxAgeSeconds: number): CorsHandler;    }                  declare var CorsHandler: {            
