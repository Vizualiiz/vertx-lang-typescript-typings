/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./session" />declare module "vertx-web-js/session_store" {  export = SessionStore;}
...
/**
   * Close the store
   */
  close(): void;    }                declare var SessionStore: {}