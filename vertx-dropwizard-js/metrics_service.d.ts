/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="../vertx-js/measured" />/// <reference path="../vertx-js/vertx" />declare module "vertx-dropwizard-js/metrics_service" {  export = MetricsService;}

/**
 * The metrics service mainly allows to return a snapshot of measured objects.
 */

declare interface MetricsService{                    
 ...
 * dropwizard backend reports to a single server.
   */
  getMetricsSnapshot(baseName: string): any;    }          declare var MetricsService: {        
