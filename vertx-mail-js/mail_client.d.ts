/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="../vertx-js/vertx" />declare module "vertx-mail-js/mail_client" {  export = MailClient;}
...
/**
   ...
   */
  close(): void;    }          declare var MailClient: {        
