/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="../vertx-auth-common-js/user" />declare module "vertx-auth-oauth2-js/access_token" {  export = AccessToken;}
 ...
 * available on all providers.
   */
  logout(callback: (res: void, err?: Throwable) => void): AccessToken;    }        declare var AccessToken: {}