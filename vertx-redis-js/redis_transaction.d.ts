/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="../vertx-js/buffer" />declare module "vertx-redis-js/redis_transaction" {  export = RedisTransaction;}
 ...
 * index represented by the sorted set.
   */
  georadiusbymemberWithOptions(key: string, member: string, radius: number, unit: any, options: any, handler: (res: string, err?: Throwable) => void): RedisTransaction;    }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      declare var RedisTransaction: {}