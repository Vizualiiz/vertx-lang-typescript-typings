/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./redis_transaction" />/// <reference path="../vertx-js/buffer" />/// <reference path="../vertx-js/vertx" />declare module "vertx-redis-js/redis_client" {  export = RedisClient;}declare interface RedisClient{                            
...
/**
   * Set the string value of a key
   */
  setWithOptions(key: string, value: string, options: any, handler: (res: string, err?: Throwable) => void): RedisClient;              
...
/**
   ...
   */
  spopMany(key: string, count: number, handler: (res: any[], err?: Throwable) => void): RedisClient;              
...
/**
   ...
   */
  geoadd(key: string, longitude: number, latitude: number, member: string, handler: (res: number, err?: Throwable) => void): RedisClient;              

/**
   * Add one or more geospatial items in the geospatial index represented using a sorted set.
   */
  geoaddMany(key: string, members: Array<any>, handler: (res: number, err?: Throwable) => void): RedisClient;              
 ...
 * a geospatial index (where elements were added using GEOADD).
   */
  geohash(key: string, member: string, handler: (res: any[], err?: Throwable) => void): RedisClient;              

/**
   * Return valid Geohash strings representing the position of one or more elements in a sorted set value representing
 * a geospatial index (where elements were added using GEOADD).
   */
  geohashMany(key: string, members: Array<string>, handler: (res: any[], err?: Throwable) => void): RedisClient;              

/**
   * Return the positions (longitude,latitude) of all the specified members of the geospatial index represented by the
 * sorted set at key.
   */
  geopos(key: string, member: string, handler: (res: any[], err?: Throwable) => void): RedisClient;              

/**
   * Return the positions (longitude,latitude) of all the specified members of the geospatial index represented by the
 * sorted set at key.
   */
  geoposMany(key: string, members: Array<string>, handler: (res: any[], err?: Throwable) => void): RedisClient;              

/**
   * Return the distance between two members in the geospatial index represented by the sorted set.
   */
  geodist(key: string, member1: string, member2: string, handler: (res: string, err?: Throwable) => void): RedisClient;              

/**
   * Return the distance between two members in the geospatial index represented by the sorted set.
   */
  geodistWithUnit(key: string, member1: string, member2: string, unit: any, handler: (res: string, err?: Throwable) => void): RedisClient;              
 ...
 * of the area specified with the center location and the maximum distance from the center (the radius).
   */
  georadius(key: string, longitude: number, latitude: number, radius: number, unit: any, handler: (res: any[], err?: Throwable) => void): RedisClient;              

/**
   * Return the members of a sorted set populated with geospatial information using GEOADD, which are within the borders
 * of the area specified with the center location and the maximum distance from the center (the radius).
   */
  georadiusWithOptions(key: string, longitude: number, latitude: number, radius: number, unit: any, options: any, handler: (res: any[], err?: Throwable) => void): RedisClient;              
 ...
 * index represented by the sorted set.
   */
  georadiusbymember(key: string, member: string, radius: number, unit: any, handler: (res: any[], err?: Throwable) => void): RedisClient;              
 ...
 * index represented by the sorted set.
   */
  georadiusbymemberWithOptions(key: string, member: string, radius: number, unit: any, options: any, handler: (res: any[], err?: Throwable) => void): RedisClient;    }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                declare var RedisClient: {        create(vertx: Vertx): RedisClient;          create(vertx: Vertx, config: any): RedisClient;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          }