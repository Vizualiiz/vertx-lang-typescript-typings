...
/// <reference path="./redis_transaction" />
...
declare interface RedisClient {
   ...
   * index represented by the sorted set.
   */
  georadiusbymemberWithOptions(key: string, member: string, radius: number, unit: any, options: any, handler: (res: any[], err?: Throwable) => void): RedisClient;
