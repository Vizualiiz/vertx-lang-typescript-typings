/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./auth_provider" />declare module "vertx-auth-common-js/user" {  export = User;}
 ...
 * after it has been deserialized.
   */
  setAuthProvider(authProvider: AuthProvider): void;    }        declare var User: {}