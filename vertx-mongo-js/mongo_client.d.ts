/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="../vertx-js/vertx" />declare module "vertx-mongo-js/mongo_client" {  export = MongoClient;}
...
/**
   ...
   */
  close(): void;    }                                                                        declare var MongoClient: {        
