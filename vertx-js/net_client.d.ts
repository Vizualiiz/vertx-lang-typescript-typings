/// <reference path="./globals.d.ts" />/// <reference path="./measured" />/// <reference path="./net_socket" />declare module "vertx-js/net_client" {  export = NetClient;}
...
declare interface NetClient  extends      Measured  {            
 ...
 * complete until some time after the method has returned.
   */
  close(): void;    }      declare var NetClient: {}