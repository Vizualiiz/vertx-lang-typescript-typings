/// <reference path="./globals.d.ts" />/// <reference path="./buffer" />/// <reference path="./write_stream" />/// <reference path="./read_stream" />/// <reference path="./web_socket_frame" />/// <reference path="./socket_address" />declare module "vertx-js/web_socket_base" {  export = WebSocketBase;}
...
declare interface WebSocketBase  extends      ReadStream  ,     WriteStream  {            
...
/**
   ...
   */
  writeQueueFull(): boolean;              exceptionHandler(handler: (e: Throwable) => void): WebSocketBase;              handler(handler: (e: Buffer) => void): WebSocketBase;              pause(): WebSocketBase;              resume(): WebSocketBase;              endHandler(endHandler: (e: void) => void): WebSocketBase;              write(data: Buffer): WebSocketBase;              setWriteQueueMaxSize(maxSize: number): WebSocketBase;              drainHandler(handler: (e: void) => void): WebSocketBase;              
...
/**
   ...
   */
  localAddress(): SocketAddress;    }                                            declare var WebSocketBase: {}