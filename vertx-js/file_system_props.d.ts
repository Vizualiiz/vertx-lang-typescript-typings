/// <reference path="./globals.d.ts" />declare module "vertx-js/file_system_props" {  export = FileSystemProps;}

/**
 * Represents properties of the file system.
 */

declare interface FileSystemProps{            
...
/**
   ...
   */
  usableSpace(): number;    }      declare var FileSystemProps: {}