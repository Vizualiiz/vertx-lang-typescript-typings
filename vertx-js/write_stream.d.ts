/// <reference path="./globals.d.ts" />/// <reference path="./stream_base" />declare module "vertx-js/write_stream" {  export = WriteStream;}
...
declare interface WriteStream  extends      StreamBase  {            
 ...
 * queue has been reduced to maxSize / 2. See Pump for an example of this being used.
   */
  drainHandler(handler: (e: void) => void): WriteStream;    }              declare var WriteStream: {}