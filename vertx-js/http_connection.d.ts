/// <reference path="./globals.d.ts" />/// <reference path="./buffer" />declare module "vertx-js/http_connection" {  export = HttpConnection;}
...
/**
   ...
   */
  exceptionHandler(handler: (e: Throwable) => void): HttpConnection;    }                                      declare var HttpConnection: {}