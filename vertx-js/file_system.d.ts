/// <reference path="./globals.d.ts" />/// <reference path="./async_file" />/// <reference path="./buffer" />/// <reference path="./file_system_props" />/// <reference path="./file_props" />declare module "vertx-js/file_system" {  export = FileSystem;}
...
/**
   ...
   */
  fsPropsBlocking(path: string): FileSystemProps;    }                                                                                                                declare var FileSystem: {}