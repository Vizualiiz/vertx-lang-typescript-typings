/// <reference path="./globals.d.ts" />/// <reference path="./vertx" />/// <reference path="./future" />declare module "vertx-js/context" {  export = Context;}
 ...
 *
 * When this handler is called, currentContext will return this context.
   */
  exceptionHandler(handler: (e: Throwable) => void): Context;    }                                    declare var Context: {        
