/// <reference path="./globals.d.ts" />/// <reference path="./command_line" />declare module "vertx-js/cli" {  export = CLI;}
...
/**
   ...
   */
  getDescription(): string;              setDescription(desc: string): CLI;              
...
/**
   ...
   */
  removeArgument(index: number): CLI;    }                                                declare var CLI: {        
