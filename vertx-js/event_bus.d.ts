/// <reference path="./globals.d.ts" />/// <reference path="./measured" />/// <reference path="./send_context" />/// <reference path="./message" />/// <reference path="./message_consumer" />/// <reference path="./message_producer" />declare module "vertx-js/event_bus" {  export = EventBus;}
...
declare interface EventBus  extends      Measured  {            
...
/**
   ...
   */
  removeInterceptor(interceptor: (e: SendContext) => void): EventBus;    }                                  declare var EventBus: {}