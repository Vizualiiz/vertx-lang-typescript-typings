/// <reference path="./globals.d.ts" />/// <reference path="./stream_base" />declare module "vertx-js/read_stream" {  export = ReadStream;}
...
declare interface ReadStream  extends      StreamBase  {            
...
/**
   ...
   */
  endHandler(endHandler: (e: void) => void): ReadStream;    }          declare var ReadStream: {}