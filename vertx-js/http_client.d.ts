/// <reference path="./globals.d.ts" />/// <reference path="./http_client_request" />/// <reference path="./http_client_response" />/// <reference path="./measured" />/// <reference path="./web_socket_stream" />/// <reference path="./multi_map" />/// <reference path="./web_socket" />declare module "vertx-js/http_client" {  export = HttpClient;}
...
declare interface HttpClient  extends      Measured  {            
 ...
 * Clients should always be closed after use.
   */
  close(): void;    }                                                                                                                                                                                                              declare var HttpClient: {}