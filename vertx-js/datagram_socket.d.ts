/// <reference path="./globals.d.ts" />/// <reference path="./packet_writestream" />/// <reference path="./buffer" />/// <reference path="./datagram_packet" />/// <reference path="./measured" />/// <reference path="./read_stream" />/// <reference path="./socket_address" />declare module "vertx-js/datagram_socket" {  export = DatagramSocket;}
...
declare interface DatagramSocket  extends      ReadStream  ,     Measured  {            
...
/**
   ...
   */
  listen(port: number, host: string, handler: (res: DatagramSocket, err?: Throwable) => void): DatagramSocket;              pause(): DatagramSocket;              resume(): DatagramSocket;              endHandler(endHandler: (e: void) => void): DatagramSocket;              handler(handler: (e: DatagramPacket) => void): DatagramSocket;              exceptionHandler(handler: (e: Throwable) => void): DatagramSocket;    }                                        declare var DatagramSocket: {}