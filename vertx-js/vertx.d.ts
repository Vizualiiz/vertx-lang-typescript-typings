/// <reference path="./globals.d.ts" />/// <reference path="./datagram_socket" />/// <reference path="./http_server" />/// <reference path="./context" />/// <reference path="./future" />/// <reference path="./shared_data" />/// <reference path="./worker_executor" />/// <reference path="./timeout_stream" />/// <reference path="./dns_client" />/// <reference path="./event_bus" />/// <reference path="./measured" />/// <reference path="./net_server" />/// <reference path="./file_system" />/// <reference path="./net_client" />/// <reference path="./http_client" />declare module "vertx-js/vertx" {  export = Vertx;}
...
declare interface Vertx  extends      Measured  {            
...
/**
   * Like createSharedWorkerExecutor but with the setWorkerPoolSize <code>poolSize</code>.
   */
  createSharedWorkerExecutor(name: string): WorkerExecutor;              

/**
   * Like createSharedWorkerExecutor but with the setMaxWorkerExecuteTime <code>maxExecuteTime</code>.
   */
...
/**
   ...
   */
  exceptionHandler(handler: (e: Throwable) => void): Vertx;    }                                                                                    declare var Vertx: {            
