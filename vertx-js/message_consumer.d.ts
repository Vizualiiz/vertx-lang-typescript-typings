/// <reference path="./globals.d.ts" />/// <reference path="./read_stream" />/// <reference path="./message" />declare module "vertx-js/message_consumer" {  export = MessageConsumer;}
...
declare interface MessageConsumer  extends      ReadStream  {            exceptionHandler(handler: (e: Throwable) => void): MessageConsumer;              handler(handler: (e: Message) => void): MessageConsumer;              pause(): MessageConsumer;              resume(): MessageConsumer;              endHandler(endHandler: (e: void) => void): MessageConsumer;              
...
/**
   * Unregisters the handler which created this registration
   */
  unregister(completionHandler: (res: void, err?: Throwable) => void): void;    }                          declare var MessageConsumer: {}