/// <reference path="./globals.d.ts" />/// <reference path="./http_server_request" />/// <reference path="./server_web_socket" />/// <reference path="./measured" />/// <reference path="./http_server_request_stream" />/// <reference path="./http_connection" />/// <reference path="./server_web_socket_stream" />declare module "vertx-js/http_server" {  export = HttpServer;}
 ...
 * signifying an ephemeral port
   */
  actualPort(): number;    }                              declare var HttpServer: {}