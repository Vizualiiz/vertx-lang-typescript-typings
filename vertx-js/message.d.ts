/// <reference path="./globals.d.ts" />/// <reference path="./multi_map" />declare module "vertx-js/message" {  export = Message;}
 ...
 * the handler will be called with a failure corresponding to the failure code and message specified here.
   */
  fail(failureCode: number, message: string): void;    }                  declare var Message: {}