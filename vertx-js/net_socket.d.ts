/// <reference path="./globals.d.ts" />/// <reference path="./buffer" />/// <reference path="./write_stream" />/// <reference path="./read_stream" />/// <reference path="./socket_address" />declare module "vertx-js/net_socket" {  export = NetSocket;}
...
declare interface NetSocket  extends      ReadStream  ,     WriteStream  {            
...
/**
   ...
   */
  writeQueueFull(): boolean;              exceptionHandler(handler: (e: Throwable) => void): NetSocket;              handler(handler: (e: Buffer) => void): NetSocket;              pause(): NetSocket;              resume(): NetSocket;              endHandler(endHandler: (e: void) => void): NetSocket;              write(data: Buffer): NetSocket;              setWriteQueueMaxSize(maxSize: number): NetSocket;              drainHandler(handler: (e: void) => void): NetSocket;              
...
/**
   ...
   */
  isSsl(): boolean;    }                                                    declare var NetSocket: {}