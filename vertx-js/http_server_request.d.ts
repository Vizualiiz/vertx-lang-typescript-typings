/// <reference path="./globals.d.ts" />/// <reference path="./server_web_socket" />/// <reference path="./http_server_file_upload" />/// <reference path="./buffer" />/// <reference path="./http_frame" />/// <reference path="./http_server_response" />/// <reference path="./multi_map" />/// <reference path="./read_stream" />/// <reference path="./http_connection" />/// <reference path="./socket_address" />/// <reference path="./net_socket" />declare module "vertx-js/http_server_request" {  export = HttpServerRequest;}
...
declare interface HttpServerRequest  extends      ReadStream  {            exceptionHandler(handler: (e: Throwable) => void): HttpServerRequest;              handler(handler: (e: Buffer) => void): HttpServerRequest;              pause(): HttpServerRequest;              resume(): HttpServerRequest;              endHandler(endHandler: (e: void) => void): HttpServerRequest;              
...
/**
   ...
   */
  connection(): HttpConnection;    }                                                                  declare var HttpServerRequest: {}