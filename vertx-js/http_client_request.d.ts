/// <reference path="./globals.d.ts" />/// <reference path="./http_client_response" />/// <reference path="./buffer" />/// <reference path="./http_frame" />/// <reference path="./write_stream" />/// <reference path="./multi_map" />/// <reference path="./read_stream" />/// <reference path="./http_connection" />declare module "vertx-js/http_client_request" {  export = HttpClientRequest;}
...
/**
   ...
   */
  writeQueueFull(): boolean;              exceptionHandler(handler: (e: Throwable) => void): HttpClientRequest;              

/**
   * @throws java.lang.IllegalStateException when no response handler is set
   */
  write(data: Buffer): HttpClientRequest;              setWriteQueueMaxSize(maxSize: number): HttpClientRequest;              drainHandler(handler: (e: void) => void): HttpClientRequest;              handler(handler: (e: HttpClientResponse) => void): HttpClientRequest;              pause(): HttpClientRequest;              resume(): HttpClientRequest;              endHandler(endHandler: (e: void) => void): HttpClientRequest;              
...
/**
   ...
   */
  writeCustomFrame(frame: HttpFrame): HttpClientRequest;    }                                                                              declare var HttpClientRequest: {}