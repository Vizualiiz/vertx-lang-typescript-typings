/// <reference path="./globals.d.ts" />/// <reference path="./mx_record" />/// <reference path="./srv_record" />declare module "vertx-js/dns_client" {  export = DnsClient;}
 ...
 * but allows you to just pass in the IP address and not a valid ptr query string.
   */
  reverseLookup(ipaddress: string, handler: (res: string, err?: Throwable) => void): DnsClient;    }                        declare var DnsClient: {}