/// <reference path="./globals.d.ts" />declare module "vertx-js/counter" {  export = Counter;}
 ...
 * atomically.
   */
  compareAndSet(expected: number, value: number, resultHandler: (res: boolean, err?: Throwable) => void): void;    }              declare var Counter: {}