/// <reference path="./globals.d.ts" />/// <reference path="./net_socket_stream" />/// <reference path="./measured" />/// <reference path="./net_socket" />declare module "vertx-js/net_server" {  export = NetServer;}

/**
 * Represents a TCP server
 */

declare interface NetServer  extends      Measured  {            
 ...
 * signifying an ephemeral port
   */
  actualPort(): number;    }                        declare var NetServer: {}