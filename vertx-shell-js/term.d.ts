/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./completion" />/// <reference path="./signal_handler" />/// <reference path="./tty" />/// <reference path="./session" />declare module "vertx-shell-js/term" {  export = Term;}

/**
 * The terminal.
 */

declare interface Term  extends Tty{            resizehandler(handler: (e: void) => void): Term;              stdinHandler(handler: (e: string) => void): Term;              write(data: string): Term;              
