/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./completion" />/// <reference path="../vertx-js/cli" />/// <reference path="./cli_token" />/// <reference path="./process" />declare module "vertx-shell-js/command" {  export = Command;}
 ...
 * or  )} method to signal completion is done.
   */
  complete(completion: Completion): void;    }          declare var Command: {}