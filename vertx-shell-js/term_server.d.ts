/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="../vertx-js/vertx" />/// <reference path="../vertx-web-js/router" />/// <reference path="./term" />/// <reference path="../vertx-auth-common-js/auth_provider" />declare module "vertx-shell-js/term_server" {  export = TermServer;}
...
/**
   ...
   */
  close(completionHandler: (res: void, err?: Throwable) => void): void;    }                              declare var TermServer: {        
