/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./job" />/// <reference path="./job_controller" />/// <reference path="./cli_token" />/// <reference path="./session" />declare module "vertx-shell-js/shell" {  export = Shell;}
