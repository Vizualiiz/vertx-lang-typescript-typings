/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="../vertx-js/command_line" />/// <reference path="../vertx-js/vertx" />/// <reference path="./cli_token" />/// <reference path="./tty" />/// <reference path="./session" />declare module "vertx-shell-js/command_process" {  export = CommandProcess;}

/**
 * The command process provides interaction with the process of the command provided by Vert.x Shell.
 */

declare interface CommandProcess  extends Tty{            
...
/**
   ...
   */
  isForeground(): boolean;              stdinHandler(handler: (e: string) => void): CommandProcess;              
...
/**
   ...
   */
  foregroundHandler(handler: (e: void) => void): CommandProcess;              resizehandler(handler: (e: void) => void): CommandProcess;              
...
/**
   * End the process.
   */
  end(status: number): void;    }                                  declare var CommandProcess: {}