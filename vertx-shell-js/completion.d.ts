/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="../vertx-js/vertx" />/// <reference path="./cli_token" />/// <reference path="./session" />declare module "vertx-shell-js/completion" {  export = Completion;}
...
/**
   ...
   */
  complete(value: string, terminal: boolean): void;    }            declare var Completion: {}