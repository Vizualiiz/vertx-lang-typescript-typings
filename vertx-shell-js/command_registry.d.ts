/// <reference path="../vertx-js/globals.d.ts" />/// <reference path="./command" />/// <reference path="../vertx-js/vertx" />/// <reference path="./command_resolver" />declare module "vertx-shell-js/command_registry" {  export = CommandRegistry;}
...
declare interface CommandRegistry  extends CommandResolver{                            
...
/**
   ...
   */
  unregisterCommand(commandName: string, completionHandler: (res: void, err?: Throwable) => void): CommandRegistry;    }                declare var CommandRegistry: {        
